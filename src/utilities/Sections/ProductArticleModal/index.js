...
return(
    <section className={styles.container} >
        ...
        {!isDesktopImage && <img src={content.bannerMob?.src || content.bannerDesk?.src} alt={content.bannerMob?.alt ||content.bannerDesk?.alt} className={styles.mobIMG} onClick={ModalHandler}/>}
      </section>
)
}
