...
const ScienceSlider2 = () => {
  ...
  const [modalImage2, setModalImage2] = useState(
    "/images/02-BMD-Tendoactive_Plus-9O3A3003-v2.webp"
  );
  ...
  const tooltipData = [
    {
      id: 1,
      author: "Prabhavathi K",
      text: "Prabhavathi K, et al. Indian J Pharmacol. 2014 Sep-Oct;46(5):475-9",
      modalHeading:
...

    {
      id: 2,
      author: "Riva A",
      text: "Riva A, et al. Eur Rev Med Pharmacol Sci. 2017 Nov;21(22):5258-5263.",
      modalHeading:
    ...
    },
    {
      id: 3,
      author: "Arbiser JL",
      text: "Arbiser JL, et al. Mol Med. 1998 Jun;4(6):376-83",
    ...
    },
    {
      id: 4,
      author: "Buhrmann C",
      text: "Buhrmann C, et al. J Biol Chem. 2011 Aug 12;286(32):28556-66.",
      modalHeading:
    ...
    },
    {
      id: 5,
      author: "de Mos M",
      text: "de Mos M, et al.,. Am J Sports Med. 2007 Sep;35(9):1549-56",
      modalHeading:
    ...
    },
    {
      id: 6,
      author: "Vieira CP",
      text: "Vieira CP et al., Connect Tissue Res. 2012;53(2):160-8.",
      modalHeading:
    ...
    },
    {
      id: 7,
      author: "Fusini F",
      text: "Fusini F. et al. Muscles Ligaments Tendons J. 2016 May 19;6(1):48-57",
      modalHeading:
    ...
    },
    {
      id: 8,
      author: "Milewska M",
      text: "Milewska Met al., Stem Cells Int. 2020;2020:9123281. Published 2020 Feb 20.",
      modalHeading:
      ...
      <div className={styles.nextCarousel}>
        <div className={`container ${styles.SliderDiv3}`}>
          <div className={`container ${styles.brunoDecription4}`}>
            <h1>Studi Clinici</h1>
            <p>Ingredienti naturali, risultati clinicamente testati</p>
          </div>
          {/* Modal Start */}
          {isModalOpen && (
          ...
          <div className={styles.main_div}>
            <div className={`container ${styles.slider3data}`}>
              <div className={styles.sliderContent}>
                ...
                >
                  <p className={styles.Pcontent} id="page-1">
                    ...
                    <br /> Aumenta significativamente la percentuale di
                    riduzione del dolore rispetto al placebo.{" "}
                    <a href="https://pubmed.ncbi.nlm.nih.gov/25298573/" target="_blank">
                      <br />
                      Prabhavathi K, et al. Indian J Pharmacol. 2014
                      Sep-Oct;46(5):475-9 <br />
                    </a>{" "}
                    Gli studi dimostrano che gli utenti possono percorrere
                    distanze più lunghe senza dolore rispetto al trattamento
                    standard
                    <br />{" "}
                    <a href="https://pubmed.ncbi.nlm.nih.gov/29228442/" target="_blank">
                      Riva A, et al. Eur Rev Med Pharmacol Sci. 2017
                      Nov;21(22):5258-5263.
                    </a>
                  </p>
                  ...
                  <p className={styles.Pcontent} id="page-2">
                    ...
                    <br />
                    La curcumina ha attività angiogenica diretta in vivo e in
                    vitro.
                    <br />
                    <a href="https://pubmed.ncbi.nlm.nih.gov/10780880" target="_blank">
                      Arbiser JL, et al. Mol Med. 1998 Jun;4(6):376-83{" "}
                    </a>{" "}
                    <p>
                      La curcumina riduce l&#39;espressione dei geni regolati da
                      NF-κB, che a sua volta è coinvolto nei processi di
                      apoptosi, degradazione della matrice e infiammazione nei
                      tenociti umani in vitro.
                      <br />
                      <a href="https://pubmed.ncbi.nlm.nih.gov/21669872//" target="_blank">
                        Buhrmann C, et al. J Biol Chem. 2011 Aug
                        12;286(32):28556-66.{" "}
                      </a>
                    </p>{" "}
                  </p>
                  ...
                  <p className={styles.Pcontent} id="page-3">
                    ...
                    <br />
                    La curcumina riduce l&#39;espressione dei geni regolati da
                    NF-κB, che a sua volta è coinvolto nei processi di apoptosi,
                    degradazione della matrice e infiammazione nei tenociti
                    umani in vitro. Nella tendinopatia, sono presenti residui di
                    lisina idrossilata derivanti dalla degradazione di questo
                    amminoacido. <br />
                    <a href="https://pubmed.ncbi.nlm.nih.gov/17478653/" target="_blank">
                      de Mos M, et al.,. Am J Sports Med. 2007 Sep;35(9):1549-56
                    </a>
                  </p>
                  <hr className={styles.blackHr} />
                  <p className={styles.Pcontent} id="page-4">
                    ...
                    <br />
                    Nella tendinopatia si riscontrano residui di prolina
                    idrossilata derivanti dalla degradazione di questo
                    amminoacido
                    <br />{" "}
                    <a href="https://pubmed.ncbi.nlm.nih.gov/22141408/" target="_blank">
                      Vieira CP et al., Connect Tissue Res. 2012;53(2):160-8.{" "}
                    </a>
                  </p>
                  <hr className={styles.blackHr} />
                  <p className={styles.Pcontent} id="page-5">
                    ...
                    <br />
                    La L-arginina è un substrato dell&#39;enzima ossido nitrico
                    sintasi (NOS), essenziale per il recupero dei tendini.
                    <br />
                    <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4915461/" target="_blank">
                      Fusini F. et al. Muscles Ligaments Tendons J. 2016 May
                      19;6(1):48-57
                    </a>
                  </p>
                  ...
                  <p className={styles.Pcontent}>
                    ...
                    <br />
                    Ottimizza il richiamo delle cellule stromali mesenchimali
                    nella zona della lesione, dove possono rilasciare fattori di
                    crescita, citochine e contrastare gli effetti dello stress
                    ossidativo nell&apos; area infiammata.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className={styles.slider2Details1}>
                ...
                <a onClick={ModalHandler}>Buy Now</a>
              </div>
            </div>
          </div>
              ...
              <div className={styles.mainModalDiv}>
                <div className={styles.modalToolTip}>
                  {modalContent.modalHeading && (
                    <h1>{modalContent.modalHeading}</h1>
                  )}
                  {modalContent.Abstract && <h2>{modalContent.Abstract}</h2>}
                  {modalContent.deccription && (
                    <p>{modalContent.deccription}</p>
                  )}
                  ...
                  {modalContent.Materials && (
                    <p>
                      <b>Materials and methods: </b>
                      {modalContent.Materials}
                    </p>
                  )}
                  {modalContent.Hypothesis && (
                    <p>
                      <b>Hypothesis: </b>
                      {modalContent.Hypothesis}
                    </p>
                  )}
                  {modalContent.StudyDesign && (
                    <p>
                      <b>Study design: </b>
                      {modalContent.StudyDesign}
                    </p>
                  )}
                  {modalContent.Methods && (
                    <p>
                      <b>Methods: </b>
                      {modalContent.Methods}
                    </p>
                  ...
                  {modalContent.Conclusion && (
                    <p>
                      <b>Conclusion: </b>
                      {modalContent.Conclusion}
                    </p>
                  )}
                  {modalContent.Clinical && (
                    <p>
