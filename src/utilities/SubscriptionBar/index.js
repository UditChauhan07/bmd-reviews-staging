...
const SubscriptionBar = ({ content, ModalHandler, active, themed = false }) => {
  if (themed) {
    return (
        <section className={styles.SubscriptionBar} id="themed" style={{background:themed}}>
          <div className={styles.SubscriptoionInner}>
            <div className={styles.container}>
              <div className={styles.row}>
                <div className={styles.colxl7}>
                  <p className={`${styles.firstLineHeader} ${styles.themedTextWhite}`} style={{fontWeight:'bolder'}}>{content.title1}</p>
                  <p className={`${styles.secondLineHeader}  ${styles.themedTextWhite}`}>{content.title2}</p>
                </div>
                  ...
                  <div className={styles.SubOneTime}>
                    ...
                    >
                      <div data-value="Subscribe">
                        <p className={styles.priceCross} data-value="Subscribe" style={active == "Subscribe" ?{color:themed}:{}}>
