        ...
        <div className={styles.container}>
            <div className={styles.firstCarousel}>
                <Carousel  interval={4000} controls={true} pause={false} className={styles.carousel} >
                    ...
                    <Carousel.Item>
                        <div className={styles.our_Carousel}>
                            <img src="/images/BMD-History-Il-Noceto-v3.webp" alt="Second slide" />
                        </div>
                    </Carousel.Item>

                    <Carousel.Item>
                        <div className={styles.our_Carousel}>
                            <img src="/images/BMD-History-b_9-v3.webp" alt="Third slide" />
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className={styles.our_Carousel}>
                            <img src="/images/BMD-History-c15-v3.webp" alt="Third slide" />
                        </div>
                    </Carousel.Item>
                </Carousel>
            </div>
