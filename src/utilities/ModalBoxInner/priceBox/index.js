...
const PriceBoxModal = ({
  ...
  theme,
    ...
    if(priceBox) {
        priceBox.priceBox.isStockBack = false
        priceBox.priceBox.isStockTheme = true
        priceBox.priceBox.isPriceBoxTheme = true
        priceBox.priceBox.oneTime.accordanTitle = false
    }
    console.warn({priceBox});
  return (
    <section>
      {isOpen === true && (
