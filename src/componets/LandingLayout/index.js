...
const LandingPage = ({ version, script, page }) => {
  ...
  const ModalHandler = (e) => {
    ...
    if(value) {setClickedType(value)}else{setClickedType('Subscribe')}
    setIsOpen(!isOpen)
  }
  ...
  return (
    ...
    <>
      ...
      {!isOpen &&<SubscriptionBar content={pageData.bottomBar} ModalHandler={ModalHandler} active={clickedType}/>}
      </>
    }
    </>
  )
